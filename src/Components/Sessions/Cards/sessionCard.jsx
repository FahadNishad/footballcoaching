...
const SessionCard = ({ data }) => {
  return (
    <div className="flex flex-col justify-between gap-3 p-3 border border-blue-gray-200 
    rounded-lg shadow-md w-[320px] h-[427px]">
      ...
      <Link className="w-full text-center text-main-dark border border-main-dark py-2 
